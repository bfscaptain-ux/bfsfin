...
# Move ICONS inside component so it has access to props
...
# Replace the chat bot phone number string
content = content.replace(
    'text: "Our rates start at 6.50% p.a. with 5-day approval guarantee. How can I help you today?"',
    'text: `Our rates start at ${"6.50%"} p.a. with 5-day approval guarantee. How can I help you today?`'
)

# Add the two floating buttons
buttons = """
...
# The return starts with `return (`. We can insert the buttons right after it.
