      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
            ...
            <div className="space-y-3 p-4 bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 rounded-2xl">
              <div className="flex justify-between items-center text-sm font-semibold">
                ...
                <span className="text-slate-900 dark:text-slate-100 font-extrabold text-lg">{currentRate.toFixed(2)}%</span>
              </div>
              <input
                type="range"
                min={6.0}
            ...
            <div className="space-y-3 p-4 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900/50 rounded-2xl">
              <div className="flex justify-between items-center text-sm font-semibold">
                ...
                <span className="text-emerald-700 dark:text-emerald-300 font-extrabold text-lg">{newRate.toFixed(2)}%</span>
              </div>
              <input
                type="range"
                min={6.0}
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 flex flex-col justify-between shadow-sm relative overflow-hidden h-full group">
            <div className="absolute top-0 right-0 w-48 h-48 bg-blue-500/10 rounded-full blur-3xl pointer-events-none transition-all duration-500 group-hover:bg-blue-500/20" />
