          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-sm font-semibold">
                ...
                <span className="text-blue-600 dark:text-blue-400 font-extrabold">{tenure} Yrs</span>
              </div>
              <input
                type="range"
                min={5}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              ...
              <select 
                ...
                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-1 focus:ring-emerald-500"
              >
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 flex flex-col justify-between shadow-sm relative overflow-hidden h-full group">
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="space-y-3 pt-4 border-t border-slate-200 dark:border-slate-800/60 text-sm">
