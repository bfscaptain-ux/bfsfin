      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 relative z-10">
                ...
                <button
                  ...
                  className={`py-2.5 px-4 rounded-xl border text-sm font-bold transition-all duration-300 ${
                    gender === g.id
                      ...
                      : "bg-slate-50 dark:bg-slate-950 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-800 hover:border-emerald-300 dark:hover:border-slate-700"
                  }`}
                >
                  {g.label}
                </button>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 flex flex-col justify-between shadow-sm relative overflow-hidden h-full group">
            <div className="absolute top-0 right-0 w-48 h-48 bg-blue-500/5 rounded-full blur-3xl pointer-events-none transition-all duration-500 group-hover:bg-blue-500/10" />
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="space-y-4 pt-6 border-t border-slate-200 dark:border-slate-800/60 text-sm">
                <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-100 dark:border-slate-800 flex justify-between items-center">
                  <div>
            ...
            <div className="pt-6 relative z-10">
              <Link
                href="/apply"
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-500 hover:to-emerald-500 text-white font-bold py-3.5 rounded-xl shadow-lg transition-all"
              >
