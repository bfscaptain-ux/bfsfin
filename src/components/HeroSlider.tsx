...
export default function HeroSlider() {
  ...
  return (
    <>
      ...
      <div className="absolute inset-0 bg-gradient-to-tr from-emerald-200/30 to-emerald-100/30 dark:from-emerald-950/60 dark:to-emerald-900/50 pointer-events-none"></div>
    </>
  );
}
