...
export default function LoanAgainstPropertyClient({ heroImageUrl, startingRate }: { heroImageUrl?: string; startingRate?: string }) {
  const [activeTab, setActiveTab] = useState<'salaried' | 'self-employed'>('self-employed');

  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-emerald-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-indigo-900 selection:text-white transition-colors duration-300">
      <Header />
      ...
      <section className="relative bg-[#020617] pt-16 pb-28 lg:pt-20 lg:pb-36 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[300px] bg-indigo-600/20 blur-[120px] rounded-full pointer-events-none"></div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 px-3 py-1 rounded-full text-[10px] font-bold text-indigo-300 uppercase tracking-widest shadow-[0_0_15px_rgba(99,102,241,0.2)] mb-4">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] tracking-tight mb-4 drop-shadow-sm">
            Unlock the Value of <br className="hidden sm:block" />
          ...
          <p className="text-base sm:text-lg text-slate-400 font-medium max-w-2xl leading-relaxed mb-8">
            Leverage your commercial, residential, or industrial real estate to secure <strong className="text-white">high-value capital</strong> for business expansion or personal milestones.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-10">
            <Link
              href="/appointment"
              className="group relative inline-flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-600 to-emerald-600 hover:from-indigo-500 hover:to-emerald-500 text-white font-bold px-8 py-3 rounded-xl shadow-[0_0_30px_rgba(79,70,229,0.3)] hover:shadow-[0_0_40px_rgba(79,70,229,0.5)] hover:-translate-y-0.5 transition-all duration-300 overflow-hidden"
            >
            ...
            <div className="flex items-center gap-2 text-sm text-slate-400 font-medium px-4">
              <CheckCircle2 className="w-5 h-5 text-indigo-400" /> Fast disbursement
            </div>
          </div>
          ...
          <div className="w-full max-w-4xl bg-white/5 backdrop-blur-xl border border-white/10 p-6 sm:p-8 rounded-3xl shadow-2xl flex flex-col sm:flex-row justify-between items-center gap-8 divide-y sm:divide-y-0 sm:divide-x divide-white/10">
            ...
            <div className="flex-1 w-full flex flex-col items-center text-center px-4 pt-4 sm:pt-0">
              ...
              <span className="text-3xl sm:text-4xl font-black text-white">{startingRate || "7.50"}%</span>
            </div>
            ...
            <div className="flex-1 w-full flex flex-col items-center text-center px-4 pt-8 sm:pt-0">
              ...
              <span className="text-3xl sm:text-4xl font-black text-white">15 Yrs</span>
            </div>
            ...
            <div className="flex-1 w-full flex flex-col items-center text-center px-4 pt-8 sm:pt-0 pb-4 sm:pb-0">
              ...
              <span className="text-3xl sm:text-4xl font-black text-white">₹10 Cr+</span>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-emerald-900 rounded-2xl p-8 border border-slate-200 dark:border-emerald-800">
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white">Property Type</h4>
                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Residential, Commercial, or Industrial property with clear titles.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center shrink-0 shadow-sm">
                  ...
                  <div>
                    ...
                    {activeTab === 'salaried' ? (
                      <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Minimum ₹30,000/month with 3+ years of total work experience.</p>
                    ) : (
                      <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Minimum ₹5 Lakhs ITR with 3+ years of business vintage.</p>
                    )}
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">700+ is ideal. We can also process cases with lower scores based on property valuation.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-emerald-900 rounded-2xl p-8 border border-slate-200 dark:border-emerald-800">
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-white dark:bg-emerald-950 rounded-xl border border-slate-200 dark:border-emerald-800">
                  ...
                  {activeTab === 'salaried' ? (
                    ...
                    <ul className="text-sm text-slate-600 dark:text-slate-400 space-y-2">
                      ...
                      <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> GST Returns (Last 12 months)</li>
                    </ul>
                  )}
                </div>
                ...
                <div className="p-4 bg-white dark:bg-emerald-950 rounded-xl border border-slate-200 dark:border-emerald-800">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400 flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-emerald-500" /> Title Deeds, Approved Plan, Latest Property Tax Receipt
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-emerald-700 dark:bg-emerald-900 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-black mb-12">Why Choose BFS for LAP?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-4">
              <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto">
                <Percent className="w-8 h-8 text-emerald-200" />
              </div>
              <h3 className="text-xl font-bold">High LTV</h3>
              <p className="text-emerald-100 text-sm">Get up to 75% of your property's market value as loan amount.</p>
            </div>
            <div className="space-y-4">
              <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto">
              ...
              <p className="text-emerald-100 text-sm">Our in-house legal experts ensure a smooth and safe mortgaging process.</p>
            </div>
            <div className="space-y-4">
              <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto">
                <Clock className="w-8 h-8 text-emerald-200" />
              </div>
              <h3 className="text-xl font-bold">Fast Disbursement</h3>
              <p className="text-emerald-100 text-sm">Quick valuation and legal clearance for faster loan disbursement.</p>
            </div>
          </div>
