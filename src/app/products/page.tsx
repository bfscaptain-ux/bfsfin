...
export default function ProductsLanding() {
  return (
    <div className="min-h-screen flex flex-col bg-emerald-950 text-slate-100 font-sans">
      <Header />
      ...
      <main className="flex-1 py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="glass-card p-8 rounded-3xl space-y-4">
            ...
            <div className="text-emerald-400 font-black text-xl">Special BT Rate: 6.45% p.a.</div>
            <Link href="/products/balance-transfer" className="inline-flex items-center gap-2 bg-emerald-600 text-white font-bold px-6 py-2.5 rounded-xl text-xs">
