  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-[#0b132b] text-slate-900 dark:text-slate-100 font-sans selection:bg-emerald-900 selection:text-white transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 dark:text-white leading-tight tracking-tight">
              Achieve Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-blue-600 to-amber-500 dark:from-emerald-400 dark:via-blue-400 dark:to-amber-400">Personal Goals.</span>
            </h1>
          ...
          >
            ...
            <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-800/60">
                  ...
                  <span className="font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 px-3 py-1 rounded-md">10.50%</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-800/60">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-bold text-slate-900 dark:text-white">₹50 Lakhs</span>
                </div>
            </div>
          </motion.div>
        </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full space-y-24 py-16">
              ...
              <ul className="space-y-6 flex-1">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">21 years to 60 years (at loan maturity).</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-slate-50 dark:bg-slate-800 rounded-full flex items-center justify-center shrink-0 border border-slate-100 dark:border-slate-700">
                  ...
                  <div>
                    ...
                    {activeTab === 'salaried' ? (
                      <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Minimum ₹15,000/month net in-hand salary.</p>
                    ) : (
                      <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Minimum ₹2.5 Lakhs ITR with 2+ years vintage.</p>
                    )}
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">750+ is mandatory for unsecured loans.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-900 dark:bg-slate-950 border border-emerald-600/30 dark:border-slate-800 p-8 sm:p-10 rounded-3xl shadow-xl flex flex-col h-full relative overflow-hidden group hover:border-emerald-500/50 transition-colors duration-300">
              ...
              <div className="space-y-6 flex-1 relative z-10">
                ...
                <div>
                  ...
                  {activeTab === 'salaried' ? (
                    <ul className="space-y-2 text-sm text-slate-300">
                      <li className="flex items-center gap-3 bg-slate-800/50 dark:bg-slate-900/50 p-2.5 rounded-xl border border-slate-700/50"><CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" /> Last 3 months Salary Slips</li>
                    ...
                    <ul className="space-y-2 text-sm text-slate-300">
                      <li className="flex items-center gap-3 bg-slate-800/50 dark:bg-slate-900/50 p-2.5 rounded-xl border border-slate-700/50"><CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" /> ITR with Computation (Last 2 years)</li>
                      <li className="flex items-center gap-3 bg-slate-800/50 dark:bg-slate-900/50 p-2.5 rounded-xl border border-slate-700/50"><CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0" /> Current Account Statement (6 months)</li>
                    </ul>
                  )}
                </div>
              </div>
        ...
        <motion.section {...fadeIn} className="space-y-10">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white">Why Choose BFS for Personal Loans?</h2>
            <p className="mt-4 text-slate-600 dark:text-slate-400">Experience seamless processing, total transparency, and unbeatable interest rates.</p>
          </div>
          ...
          <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-100px" }} className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div variants={fadeIn} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">24-Hour Disbursal</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">Once approved, funds hit your bank account within 24 hours.</p>
            </motion.div>
            ...
            <motion.div variants={fadeIn} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Zero Collateral</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">No guarantors or security required. Purely based on your financial strength.</p>
            </motion.div>
            ...
            <motion.div variants={fadeIn} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Best Rate Matching</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">We scan offers from 50+ banking partners to get you the lowest interest rate.</p>
            </motion.div>
      ...
      <SEOContentBlock productName="Personal Loan" />
