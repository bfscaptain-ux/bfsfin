  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-emerald-900 border border-emerald-800 p-6 rounded-3xl">
        <div>
          <h1 className="text-2xl font-black text-white flex items-center gap-2">
            <Briefcase className="w-6 h-6 text-emerald-400" /> Application Dockets Manager
          </h1>
      ...
      <div className="space-y-4">
        {filtered.map((a) => (
          <div key={a.appNo} className="bg-emerald-900 border border-emerald-800 p-6 rounded-3xl space-y-4 shadow-xl">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-emerald-800 pb-3">
              <div>
                <span className="font-mono text-xs font-bold text-emerald-400">{a.appNo}</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 bg-emerald-950 p-4 rounded-2xl border border-emerald-800 text-xs">
              <div>
            ...
            <div className="flex items-center justify-between pt-2 text-xs">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="bg-emerald-950 text-emerald-300 hover:bg-emerald-600 hover:text-white px-3 py-1.5 rounded-xl border border-emerald-500/30 font-bold"
                >
