      ...
      <main>
        ...
        <section className="relative flex items-center justify-center overflow-hidden pt-12 pb-24">
          ...
          <div className="absolute inset-0 bg-slate-50 dark:bg-slate-900 z-0">
            ...
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-600/20 blur-[100px] rounded-full opacity-30 dark:opacity-50 mix-blend-multiply dark:mix-blend-screen pointer-events-none" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                ...
                >
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500">Dream Home.</span>
                </motion.h1>
              ...
              <div className="relative hidden lg:block h-[160px]">
                ...
                <motion.div 
                  ...
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-gradient-to-br from-emerald-400 to-blue-500 rounded-full blur-[80px] opacity-40 -z-10"
                />
              </div>
            </div>
          </div>
        ...
        <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="absolute -inset-4 bg-gradient-to-tr from-emerald-500/20 to-blue-500/20 rounded-3xl blur-2xl opacity-50 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative aspect-[4/5] rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-2xl bg-white dark:bg-slate-900 flex items-center justify-center group-hover:shadow-emerald-500/10 transition-shadow">
                <Image src="/praveen_bhardwaj.png" alt="Mr. Vinita Bhardwaj" fill className="object-cover" />
                
                {/* Experience Badge overlay */}
                <div className="absolute bottom-6 left-6 right-6 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md rounded-2xl p-6 border border-slate-200/50 dark:border-slate-700/50 shadow-xl translate-y-4 group-hover:translate-y-0 opacity-90 group-hover:opacity-100 transition-all duration-300">
                  <div className="flex items-center gap-4">
            ...
            >
              <div>
                <h2 className="text-sm font-black text-emerald-600 dark:text-emerald-400 tracking-widest uppercase mb-2">From the Owner's Desk</h2>
                <h3 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white leading-[1.1]">
                  Mrs. Vinita Sharma
                </h3>
                <p className="text-xl text-slate-500 dark:text-slate-400 mt-2 font-medium">Owner, BFS</p>
              </div>

              <div className="prose prose-lg dark:prose-invert text-slate-600 dark:text-slate-300">
                <p>
                  Before founding Bhardwaj Financial Services, Mrs. Vinita Sharma spent over a decade working closely within India's top banking institutions. She witnessed firsthand the anxiety, delays, and lack of transparency ordinary families faced when applying for home loans. 
                </p>
                <p>
                  Driven by a vision to simplify the complex mortgage landscape, she established BFS with a single mission: <strong>To make funding accessible, fast, and completely transparent.</strong>
                </p>
              </div>

              <blockquote className="relative p-8 bg-blue-50 dark:bg-blue-950/30 rounded-3xl border border-blue-100 dark:border-blue-900/50">
                <div className="absolute top-0 left-8 -translate-y-1/2 text-6xl text-blue-300 dark:text-blue-800 font-serif">"</div>
        ...
        <section className="py-24 bg-slate-100/50 dark:bg-slate-900/20 border-y border-slate-200 dark:border-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {/* Dummy Team Member 1 */}
              <motion.div variants={fadeInUp} className="group relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-300">
                <div className="h-48 bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-800 dark:to-slate-700 flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                   <Users className="w-16 h-16 text-slate-400 dark:text-slate-600" />
                </div>
                <div className="p-8 relative bg-white dark:bg-slate-900 z-10">
                  <div className="absolute -top-6 right-8 w-12 h-12 bg-emerald-500 rounded-full flex items-center justify-center text-white shadow-lg shadow-emerald-500/30 group-hover:-translate-y-1 transition-transform">
                    <ShieldCheck className="w-6 h-6" />
                  </div>
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Amit Sharma</h3>
                  <div className="text-emerald-600 dark:text-emerald-400 font-bold text-sm uppercase tracking-wide mb-4">Head of Credit & Risk</div>
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-6">
                    Former credit manager at top tier banks, Amit ensures that your file is pre-screened perfectly so that it never faces a rejection.
                  </p>
                  <a href="#" className="inline-flex items-center text-sm font-bold text-slate-900 dark:text-white hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                    Connect on LinkedIn <ChevronRight className="w-4 h-4 ml-1" />
                  </a>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="group relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-8 relative bg-white dark:bg-slate-900 z-10">
                  <div className="absolute -top-6 right-8 w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-white shadow-lg shadow-blue-500/30 group-hover:-translate-y-1 transition-transform">
                    <Rocket className="w-6 h-6" />
                  </div>
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Priya Verma</h3>
                  <div className="text-blue-600 dark:text-blue-400 font-bold text-sm uppercase tracking-wide mb-4">VP of Bank Alliances</div>
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-6">
                    Priya manages our deep relationships with over 50+ Banks and NBFCs, ensuring BFS gets priority processing everywhere.
                  </p>
                  <a href="#" className="inline-flex items-center text-sm font-bold text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                    Connect on LinkedIn <ChevronRight className="w-4 h-4 ml-1" />
                  </a>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="group relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-8 relative bg-white dark:bg-slate-900 z-10">
                  <div className="absolute -top-6 right-8 w-12 h-12 bg-amber-500 rounded-full flex items-center justify-center text-white shadow-lg shadow-amber-500/30 group-hover:-translate-y-1 transition-transform">
                    <Briefcase className="w-6 h-6" />
                  </div>
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Anuj Kumar</h3>
                  <div className="text-amber-600 dark:text-amber-400 font-bold text-sm uppercase tracking-wide mb-4">IT Manager</div>
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-6">
                    Anuj leads the technology infrastructure at BFS, ensuring our digital platforms, partner portals, and internal systems are secure, fast, and always online.
                  </p>
                  <a href="#" className="inline-flex items-center text-sm font-bold text-slate-900 dark:text-white hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                    Connect on LinkedIn <ChevronRight className="w-4 h-4 ml-1" />
                  </a>
                </div>
              </motion.div>
        ...
        <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-lg hover:border-emerald-500/50 transition-colors"
            >
            ...
            <motion.div 
              ...
              className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-lg hover:border-blue-500/50 transition-colors"
            >
            ...
            <motion.div 
              ...
              className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-lg hover:border-amber-500/50 transition-colors"
            >
        ...
        <section className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative bg-slate-900 rounded-[3rem] overflow-hidden p-12 md:p-20 text-center shadow-2xl">
