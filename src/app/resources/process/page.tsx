      ...
      <section className="relative pt-20 pb-24 bg-gradient-to-br from-emerald-50 to-emerald-50 dark:from-slate-900 dark:to-emerald-950 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-6">
          ...
          <motion.h1 {...fadeIn} className="text-4xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight">
            The Loan <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-emerald-600">Process Guide</span>
          </motion.h1>
        </div>
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full -mt-10 relative z-20 pb-20">
        <div className="relative border-l-4 border-emerald-200 dark:border-emerald-900/50 ml-6 md:ml-12 py-10 space-y-16">
          {steps.map((step, idx) => (
            ...
            >
              <div className="absolute -left-[38px] top-0 w-16 h-16 bg-white dark:bg-emerald-900 border-4 border-emerald-200 dark:border-emerald-800 rounded-full flex items-center justify-center shadow-lg">
                {step.icon}
              </div>
              <div className="bg-white dark:bg-emerald-900 border border-slate-200 dark:border-emerald-800 p-8 rounded-3xl shadow-sm hover:shadow-xl transition-shadow">
