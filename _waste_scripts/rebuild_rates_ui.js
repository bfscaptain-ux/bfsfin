...
content = content.replace(
  'lapRate: "7.50",',
  'lapRate: "7.50",\n    selfEmployedRate: "7.25",\n    goldLoanRate: "8.50",'
);

// 2. Add fields to fetch mapping
content = content.replace(
...
// 3. Replace the entire Product Starting Interest Rates section
...
const oldSectionEnd = 'Banner & Ticker Announcement Controls'; // Use this to find the end
