...
if (!content.includes('activeProductTab')) {
  content = content.replace(
...
// 2. Build the new unified Mega Menu
                ...
                <div className="absolute left-1/2 -translate-x-1/2 top-[70px] hidden group-hover:flex w-[950px] min-h-[420px] bg-white dark:bg-[#0f172a] border border-slate-100 dark:border-emerald-800 rounded-2xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] dark:shadow-none overflow-hidden z-50">
                  ...
                  <div className="w-[280px] shrink-0 bg-slate-50/80 dark:bg-emerald-950/20 border-r border-slate-100 dark:border-emerald-800/50 p-6 flex flex-col gap-3">
                    ...
                    <button 
                      ...
                      className={\`w-full text-left px-5 py-4 rounded-xl font-bold transition-all flex items-center justify-between \${activeProductTab === 'finance' ? 'bg-white dark:bg-emerald-900 shadow-sm text-emerald-600 dark:text-emerald-400 border border-slate-100 dark:border-emerald-800' : 'text-slate-600 dark:text-slate-400 hover:bg-white/60 dark:hover:bg-emerald-900/30'}\`}
                    >
                    ...
                    <button 
                      ...
                      className={\`w-full text-left px-5 py-4 rounded-xl font-bold transition-all flex items-center justify-between \${activeProductTab === 'insurance' ? 'bg-white dark:bg-emerald-900 shadow-sm text-emerald-600 dark:text-emerald-400 border border-slate-100 dark:border-emerald-800' : 'text-slate-600 dark:text-slate-400 hover:bg-white/60 dark:hover:bg-emerald-900/30'}\`}
                    >
                      <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 relative bg-white dark:bg-[#0f172a]">
                    ...
                    <div className={\`absolute inset-0 p-10 transition-all duration-300 \${activeProductTab === 'insurance' ? 'opacity-100 z-10 translate-y-0' : 'opacity-0 z-0 translate-y-4 pointer-events-none'}\`}>
                      <div className="bg-emerald-50 dark:bg-emerald-950/30 rounded-xl p-4 mb-6 flex items-center justify-between border border-emerald-100 dark:border-emerald-900/50">
                        <div>
                          <div className="font-black text-emerald-800 dark:text-emerald-400 text-lg">Insurance Vertical Launching Soon</div>
                          <div className="text-emerald-600 dark:text-emerald-500 text-sm mt-0.5 font-medium">We are bringing India's best insurance policies to Agra.</div>
                        </div>
                        <div className="bg-emerald-500 text-white px-3 py-1 rounded-full text-xs font-bold tracking-widest uppercase shadow-sm">Coming 2026</div>
                      </div>
                      <div className="grid grid-cols-2 gap-10 text-left opacity-60 pointer-events-none">
                        <div className="space-y-4">
                          <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 border-b border-slate-100 dark:border-emerald-800/50 pb-3 mb-5">
                            <Users className="w-5 h-5" />
                            <h4 className="font-black text-slate-900 dark:text-white text-base">Life & Health</h4>
                          </div>
                          <div className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Term Life Insurance</div>
                          <div className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Health Insurance</div>
                          <div className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Family Floater Plans</div>
                          <div className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Critical Illness Cover</div>
                        </div>
                        <div className="space-y-4">
                          <div className="flex items-center gap-2 text-amber-500 dark:text-amber-400 border-b border-slate-100 dark:border-emerald-800/50 pb-3 mb-5">
                            <ShieldCheck className="w-5 h-5" />
                          ...
                          <div className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Comprehensive Car Insurance</div>
                          <div className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Two Wheeler Insurance</div>
                          <div className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Home Property Insurance</div>
                          <div className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Business / Shop Insurance</div>
                        </div>
                      </div>
                    </div>
...
const endIndex = content.indexOf('{/* Tools Dropdown */}');
